...
public class Veg extends Activity {
    ...
    public void total_cal(){
       total_veg=roti*(170)+butter_roti*(170)+paneer_tikka*(180)+veg_pulao*(195)+mutter_paneer*(190)+veg_noodles*(100)+veg_fried_rice*(120)+veg_burger*(150)+veg_biryani*(150)+paneer_kofta*(180);
