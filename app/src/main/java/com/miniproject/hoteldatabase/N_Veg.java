...
public class N_Veg extends Activity {
    ...
    static int squid_ghee;
    static int prawns_biriyani;
    ...
    public void prawns_biriyani_inc(View view){
        prawns_biriyani=inc(prawns_biriyani);
        TextView tv = (TextView) findViewById(R.id.prawns_biriyani_order);
        tv.setText("" + prawns_biriyani);
        total_cal();
    }
    public void prawns_biriyani_dec(View view) {
        if (prawns_biriyani >= 0) {
            prawns_biriyani= dec(prawns_biriyani);
            TextView tv = (TextView) findViewById(R.id.prawns_biriyani_order);
            if(prawns_biriyani>0) tv.setText("" + prawns_biriyani);
            else tv.setText("__");
            total_cal();

        }
    }
    public void squid_ghee_inc(View view){
        squid_ghee=inc(squid_ghee);
        TextView tv = (TextView) findViewById(R.id.muryani_order);
        tv.setText("" + squid_ghee);
        total_cal();
    }
    public void squid_ghee_dec(View view) {
        if (squid_ghee >= 0) {
            squid_ghee= dec(squid_ghee);
            TextView tv = (TextView) findViewById(R.id.muryani_order);
            if(squid_ghee>0) tv.setText("" + squid_ghee);
            else tv.setText("__");
            total_cal();
    ...
    public void total_cal() {
        n_veg_total = chicken_burger * (325) + chicken_bbq_pizza * (310) + chicken_tikka * (300) + fried_fish_rice * (320) + kolhapuri_chicken * (350) + chicken_noodles * (130) + chicken_fried_rice * (150) + chicken_lollipop * (180) + chicken_biryani * (180) + mutton_biryani * (220)+squid_ghee*(220)+prawns_biriyani*(220);
        finalize_order.all_total = Veg.total_veg + N_Veg.n_veg_total + Dessert.dessert_total;
