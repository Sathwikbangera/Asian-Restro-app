...
public class Dessert extends Activity {
    ...
    public void total_cal() {
        dessert_total = chocolate_ice_cream * (60) + vanilla_ice_cream * (80) + strawberry_ice_cream * (150) + falooda * (150) + brownie_fudge * (175) + alpine_chocolate * (120) + devils_delight * (120) + black_forest * (135) + chocolate_lava * (135) + dutch_almond * (135);
